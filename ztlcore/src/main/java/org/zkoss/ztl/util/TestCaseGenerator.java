...
public class TestCaseGenerator {
	...
	public String generatorTestCase(String filename,String pkg){
		//FIXME ....
		/*try {
	...
	private Test load(File f, String src) {
		try {
			String fileName = convertFileName(f.getName());
			...
			return createTest(f,fileName,pkg);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
	...
	public Test createTest(File f,String fileName,String pkg){
	...
	public static void main(String[] args) {
		args=new String[]{"-src","test","-dist","codegen","-run","build//test","auxhead"};
